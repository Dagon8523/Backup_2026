...
--trabajos academicos
	...
	t1."HE_EVPADS_0", 
	t1."STU_UNIT_STATE",
	p1."HE_SNIES" AS "PROGRAM_SNIES_ID",
--Matriculados
...
FROM "2_LT_DP_HE_DS010_01" AS t1 LEFT JOIN "1_0HE_PRGRM" AS p1 ON t1."PROGRAM_OBJECTID" = p1."HE_PRGRM"
  

	LEFT JOIN  "3_LT_DP_MATEST_01" AS t2 ON t1."HE_STUDNT" = t2."STUDNT" AND t1."PROGRAM_OBJECTID" = t2."PRGRM" AND t1."ACAD_YEARPERID" = t2."YRSES"
	LEFT JOIN  "1_LT_S4_ZHE_PROGA_EVENT_01" AS t3 ON t1."EVPACK_OBJECTID" = t3."OBJID_SE" 
	LEFT JOIN (
	SELECT 
		I."Date",
		I."Check_In_Time",
